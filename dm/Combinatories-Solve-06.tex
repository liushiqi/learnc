...
\begin{enumerate}
  ...
  \item[4.] \textit{(2分)} $p$是奇素数,计算$\left(\frac{-3}{p}\right)$。 \\
    \begin{proofs}{解:}
      $$\left(\frac{-3}{p}\right) = \left(-1\right)^{\frac{p - 1}{2}}\left(\frac{3}{p}\right) = \left(-1\right)^{(p - 1)^2}\left(\frac{p}{3}\right) = \left(\frac{p}{3}\right)$$
      \begin{equation*}
